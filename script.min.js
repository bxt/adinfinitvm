...
var DictSet,GridBase,Possibilities,PossibilityGrid,Quad,extend=function(t,i){function e(){this.constructor=t}for(var r in i)hasProp.call(i,r)&&(t[r]=i[r]);return e.prototype=i.prototype,t.prototype=new e,t.__super__=i.prototype,t},hasProp={}.hasOwnProperty;GridBase=require("../GridBase"),Possibilities=require("./Possibilities"),Quad=require("../Quad"),DictSet=require("./DictSet"),module.exports=PossibilityGrid=function(t){function i(){return i.__super__.constructor.apply(this,arguments)}return extend(i,t),i.prototype.createTodo=function(){return new DictSet(function(t){return function(i){var e,r;return e=i[0],r=i[1],r*t.w+e}}(this))},i.prototype.newDefault=function(){return new Possibilities(1)},i.prototype.eliminiateFrom=function(t){var i,e,r,o,n,s,u;for(s=t[0],u=t[1],n=this.createTodo(),o=Quad.neighbors(s,u),i=0,e=o.length;i<e;i++)r=o[i],n.add(r);return this.eliminiate(n)},i.prototype.eliminiateInitial=function(){var t,i,e,r,o,n,s;for(o=this.createTodo(),e=this.allCoordinates(),t=0,i=e.length;t<i;t++)r=e[t],n=r[0],s=r[1],0!==n&&0!==s&&n!==this.w-1&&s!==this.h-1&&1!==this.getAt(n,s).length()||o.add([n,s]);return this.eliminiate(o)},i.prototype.eliminiate=function(t){for(var i,e,r,o,n,s,u,a,p,d,l,h,c;e=t.pop();)if(h=e[0],c=e[1],this.contains(h,c))for(d=Quad.all,i=0,o=d.length;i<o;i++)if(p=d[i],u=this.getAt(h,c),a=u.id,u.eliminiate(this.getAtToQuad(h,c,p),p),a!==u.id)for(l=Quad.neighbors(h,c),r=0,n=l.length;r<n;r++)s=l[r],t.add(s);return this},i.prototype.solved=function(){return this.toArray().every(function(t){return 1===t.length()})},i}(GridBase);
},{"../GridBase":4,"../Quad":6,"./DictSet":8,"./Possibilities":9}],11:[function(require,module,exports){
var Possibilities,PossibilityGrid,Solver;PossibilityGrid=require("./PossibilityGrid"),Possibilities=require("./Possibilities"),module.exports=Solver=function(){function i(){}return i.prototype.solve=function(i){var e,t,o,r,s,n,l,u,a,d,f,g,h,p,b,c;for(l=new PossibilityGrid(i.w,i.h,function(e,t){return Possibilities.forSquare(i.getAt(e,t))}),h=[],l.eliminiateInitial(),h.push([0,l]);;){if(u=h.pop(),p=u[0],l=u[1],l.solved())break;if(console.log("popping "+p),f=this.fixOnePossibility(p,l),f.deadend||f.exhausted)console.log(f);else for(e=0,o=f.length;e<o;e++)s=f[e],h.push(s)}for(a=i.allCoordinates(),g=[],t=0,r=a.length;t<r;t++)d=a[t],b=d[0],c=d[1],n=l.getAt(b,c).toArray(),1===n.length?g.push(i.getAt(b,c).setId(n[0])):g.push(void 0);return g},i.prototype.fixOnePossibility=function(i,e){var t,o,r,s,n,l,u,a,d,f,g;for(t=i,a=e.allCoordinates(),r=0,s=a.length;r<s;r++){if(d=a[r],f=d[0],g=d[1],l=e.getAt(f,g),u=l.toArray(),0===u.length)return{deadend:!0};if(u.length>1&&(t-=u.length,t<0))return o=u.length+t,n=e.clone(),console.log("fixing "+[f,g]),l.clear().add(u[o]),e.eliminiateFrom([f,g]),[[i+1,n],[0,e]]}return{exhausted:!0}},i}();
...
var Button,Solve,Solver,bind=function(t,e){return function(){return t.apply(e,arguments)}},extend=function(t,e){function r(){this.constructor=t}for(var o in e)hasProp.call(e,o)&&(t[o]=e[o]);return r.prototype=e.prototype,t.prototype=new r,t.__super__=e.prototype,t},hasProp={}.hasOwnProperty;Button=require("../viewBase/Button"),Solver=require("../model/solve/Solver"),module.exports=Solve=function(t){function e(t){this.main=t,this.clicked=bind(this.clicked,this),e.__super__.constructor.call(this),this.dom.innerHTML="?",this.dom.className="button solver"}return extend(e,t),e.prototype.clicked=function(t){var e,r,o,n,i,s;for(s=new Solver,s.solve(this.main.gridView.grid),o=this.main.gridView.squareViews,n=[],e=0,r=o.length;e<r;e++)i=o[e],n.push(i.refreshDom());return n},e}(Button);
