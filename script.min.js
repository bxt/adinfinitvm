...
(function() {
  var DIRECTIONS, Grid, GridView, Square, SquareDesigns, SquareView, Zoo, zoo,
  ...
  Zoo = (function() {
    ...
    fixedLevels = {
      ...
      1: makeGrid(5, 9, [4, 6, 10, 10, 12, 1, 5, 6, 14, 9, 6, 13, 5, 1, 0, 7, 11, 13, 2, 1, 5, 4, 5, 6, 12, 7, 14, 15, 6, 8, 7, 6, 14, 11, 13, 5, 5, 2, 3, 13, 1, 3, 8, 3, 9])
    };
    ...
    Zoo.prototype.loadLevel = function() {
      this.gridView = new GridView(fixedLevels[this.level]);
