...
(function() {
  var BitSet, Button, Component, DIRECTIONS, Grid, GridView, Header, Instructions, Interval, Levels, Main, PathySquareDesigns, Solver, Square, SquareDesigns, SquareView, TriangularSquareDesigns, main,
  ...
  Interval = (function() {
    ...
    Interval.prototype.start = function() {
      return this.dom = window.setInterval(this.callback, this.time);
    };

    Interval.prototype.stop = function() {
      window.clearInterval(this.dom);
      return this.dom = null;
    };
  ...
  Main = (function(superClass) {
    ...
    function Main() {
      ...
      this.clicked = bind(this.clicked, this);
      Main.__super__.constructor.call(this, 'div');
      this.dom.classList.add('main');
    ...
    Main.prototype.createDesignChanger = function() {
    ...
    Main.prototype.clicked = function() {
      var cL;
    ...
    Main.prototype.persistLevelProgress = function() {
      var level;
