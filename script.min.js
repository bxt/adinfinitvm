...
(function() {
  ...
  Levels = (function() {
    ...
    Levels.prototype.get = function(level) {
      var grid;
      grid = fixedLevels[level] || this.generateLevel();
      shuffle(grid);
      return grid;
    };
  ...
  fixedLevels = {
    ...
    4: makeGrid(6, 6, [0, 0, 6, 12, 0, 0, 0, 4, 5, 7, 8, 0, 6, 11, 15, 15, 10, 12, 3, 10, 15, 15, 14, 9, 0, 2, 13, 5, 1, 0, 0, 0, 3, 9, 0, 0]),
    5: makeGrid(4, 5, [0, 6, 12, 0, 0, 5, 5, 0, 0, 5, 5, 0, 6, 13, 7, 12, 3, 9, 3, 9]),
    6: makeGrid(6, 6, [0, 0, 6, 12, 0, 0, 0, 4, 7, 13, 4, 0, 6, 11, 15, 15, 11, 12, 3, 14, 15, 15, 14, 9, 0, 1, 7, 13, 1, 0, 0, 0, 3, 9, 0, 0]),
    7: makeGrid(6, 6, [4, 6, 10, 10, 10, 8, 5, 5, 6, 10, 10, 12, 5, 5, 1, 2, 12, 5, 5, 3, 8, 4, 5, 5, 3, 10, 10, 9, 5, 5, 2, 10, 10, 10, 9, 1]),
    12: makeGrid(5, 9, [4, 6, 10, 10, 12, 1, 5, 6, 14, 9, 6, 13, 5, 1, 0, 7, 11, 13, 2, 1, 5, 4, 5, 6, 12, 7, 14, 15, 6, 8, 7, 6, 14, 11, 13, 5, 5, 2, 3, 13, 1, 3, 8, 3, 9]),
    100: makeGrid(5, 3, [4, 6, 12, 6, 12, 5, 5, 5, 5, 5, 1, 3, 9, 3, 9])
  };
