...
var Possibilities,PossibilityGrid,Solver;PossibilityGrid=require("./PossibilityGrid"),Possibilities=require("./Possibilities"),module.exports=Solver=function(){function i(){}return i.prototype.solve=function(i){var e,t,r,o,n,s,l,a,d,u,f,h,g,b,y,P;for(a=new PossibilityGrid(i.w,i.h,function(e,t){return Possibilities.forSquare(i.getAt(e,t))}),a.eliminiateInitial(),g=[],g.push([0,a]),e=0;;){if(d=g.pop(),b=d[0],a=d[1],a.solved())break;if(h=this.fixOnePossibility(b,a),h.deadend)e++;else{if(h.exhausted)throw new Error("Invalid State");for(t=0,o=h.length;t<o;t++)s=h[t],g.push(s)}}for(u=i.allCoordinates(),r=0,n=u.length;r<n;r++)f=u[r],y=f[0],P=f[1],l=a.getAt(y,P).toArray(),1===l.length&&i.getAt(y,P).setId(l[0]);return e},i.prototype.fixOnePossibility=function(i,e){var t,r,o,n,s,l,a,d,u,f,h;for(t=i,d=e.allCoordinates(),o=0,n=d.length;o<n;o++){if(u=d[o],f=u[0],h=u[1],l=e.getAt(f,h),a=l.toArray(),0===a.length)return{deadend:!0};if(a.length>1&&(t-=a.length,t<0))return r=a.length+t,s=e.clone(),l.clear().add(a[r]),e.eliminiateFrom([f,h]),[[i+1,s],[0,e]]}return{exhausted:!0}},i}();
...
var Button,Solve,Solver,bind=function(t,e){return function(){return t.apply(e,arguments)}},extend=function(t,e){function r(){this.constructor=t}for(var o in e)hasProp.call(e,o)&&(t[o]=e[o]);return r.prototype=e.prototype,t.prototype=new r,t.__super__=e.prototype,t},hasProp={}.hasOwnProperty;Button=require("../viewBase/Button"),Solver=require("../model/solve/Solver"),module.exports=Solve=function(t){function e(t){this.app=t,this.clicked=bind(this.clicked,this),e.__super__.constructor.call(this),this.dom.innerHTML="?",this.dom.className="button solver"}return extend(e,t),e.prototype.clicked=function(t){var e,r,o,n,i,s,u;for(u=new Solver,e=u.solve(this.app.gridView.grid),n=this.app.gridView.squareViews,i=[],r=0,o=n.length;r<o;r++)s=n[r],i.push(s.refreshDom());return i},e}(Button);
