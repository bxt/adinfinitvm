...
(function() {
  var Button, DIRECTIONS, Grid, GridView, Header, Instructions, Levels, PathySquareDesigns, Square, SquareDesigns, SquareView, TriangularSquareDesigns, Zoo, zoo,
  ...
  TriangularSquareDesigns = (function(superClass) {
    ...
    TriangularSquareDesigns.prototype.loadPaths = function() {
      return this.paths = {
  ...
  SquareView = (function(superClass) {
    ...
    SquareView.prototype.refreshDom = function() {
      this.squareDesigns.setSquare(this.square).addTo(this.dom);
  ...
  Levels = (function() {
    ...
    Levels.prototype.generateLevel = function(level) {
      ...
      density = 0.5;
      return generateLevel(w, h, density, random);
    };

    generateLevel = function(maxW, maxH, density, random) {
      var antiquad, grid, h, j, l, len, p, quad, quads, ref, ref1, w, x, y;
      if (random == null) {
        random = Math.random;
      }
  ...
  Instructions = (function() {
    ...
    Instructions.prototype.startMessage = function(level) {
      switch (level) {
        ...
        case 4:
          return "(you still know the game is called AD·INFINITVM·ATQVE·PLVS·VLTRA, right?)";
        default:
          return "&nbsp;";
      }
    };
    ...
    Instructions.prototype.endMessage = function(level) {
      switch (level) {
        ...
        default:
          if (("" + level).match(/^[15]0+$/)) {
            return withDashes("congratulations! you reached #" + level + ". <a class=\"button\" href=\"http://twitter.com/home?status=" + (encodeURIComponent("I just made it to level " + level + " in @amoebe's #adinfinitvm game!")) + "\">tweet</a>");
          } else {
  ...
  Header = (function() {
    ...
    Header.prototype.hide = function() {
      this.dom.style.height = this.dom.clientHeight + "px";
      this.dom.offsetHeight;
      return this.dom.style.height = 0;
    };
  ...
  Zoo = (function() {
    ...
    Zoo.prototype.createDesignChanger = function() {
      ...
      return this.designChanger.addTo(this.dom);
    };
